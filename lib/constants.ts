...
export const categories = [
   ...
   { id: 'gifts', name: 'Gifts', icon: Gift, color: '#F472B6', bgColor: '#FCE7F3' },
   { id: 'clothing', name: 'Clothing', icon: Shirt, color: '#6B7280', bgColor: '#F3F4F6' },
   { id: 'personal_care', name: 'Personal Care', icon: Scissors, color: '#9333EA', bgColor: '#F3E8FF' },
   { id: 'business', name: 'Business', icon: Briefcase, color: '#2563EB', bgColor: '#DBEAFE' },
   { id: 'subscriptions', name: 'Subscriptions', icon: CreditCard, color: '#DC2626', bgColor: '#FEE2E2' },
